<template>
    <div class="leleo-typewriter" style="text-align: center; cursor: pointer;" @dblclick="$emit('dblclick')"><span class="qm">" </span><span ref="text" class="msg"></span><span class="qm"> "</span></div>
</template>
